module.exports = {
	...
	execute(client, interaction, args){
		try {
			if(!interaction.guild.channels.cache.get(args[1]) || !interaction.guild.channels.cache.get(args[1]).type === "GUILD_TEXT")return interaction.reply({content: "Channel is either not from this guild or invalid please try again"});
